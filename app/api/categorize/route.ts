...
const LOCAL_MAP: [string[], Category][] = [
  ...
  // meat
  [["עוף", "בשר", "פרגית", "כנפיים", "שניצל", "חזה", "ירך", "בקר", "כבש", "הודו", "דג", "סלמון", "טונה", "בורי", "דניס", "לוקוס", "קרפיון", "נקניק", "נקניקיה", "המבורגר", "ביצ", "כבד", "שפונדרה", "אנטריקוט", "פילה"], "meat"],
  // vegetables_fruits
  ...
  // dry_goods
  [["לחם", "פיתה", "בגט", "חלה", "לחמניה", "אורז", "פסטה", "ספגטי", "מקרוני", "קמח", "סוכר", "מלח", "שמן", "זית", "חמניות", "קנולה", "קפה", "תה", "קורנפלקס", "שיבולת", "מוזלי", "גרנולה", "עוגיות", "ביסקוויט", "שוקולד", "ממתק", "ריבה", "דבש", "טחינה", "חומוס", "מיונז", "קטשופ", "חרדל", "רוטב", "שימורים", "קופסא", "פח", "קרקר", "צ'יפס", "חטיף", "אגוזים", "שקדים", "גרעינים", "פיסטוק", "קשיו", "צנים", "לחם קרוב"], "dry_goods"],
];
